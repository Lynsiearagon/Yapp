    ...
    <>
      ...
      <div id="formAndImageWrapperSignUp">
        <div id="signupPageWrapper">
          <header id="signupHeaderDiv">
            ...
            <span>
              <p id="termsAndConditions">
                By continuing, you agree to Yapp's
                <a
                  href="https://terms.yelp.com/tos/en_us/20200101_en_us/"
                  className="externalsignupFormLinks"
                >
                  {" "}
                  Terms of Service
                </a>{" "}
                and acknowledge Yapp's
                <a
          ...
          <div>
            <a
              href="https://www.linkedin.com/in/lynsie-aragon-87156a157/"
              target="_blank"
              rel="noreferrer"
            >
              <button id="linkedInButton" className="signupFormButtons">
                <img src={linkedin} alt="LinkedIn logo" id="linkedinLogo" />
                <p>Follow Me on LinkedIn</p>
              </button>
            </a>
            <a
              href="https://angel.co/u/lynsie-aragon"
              target="_blank"
              rel="noreferrer"
            >
              <button id="wellFoundButton" className="signupFormButtons">
            ...
            <a
              ...
              rel="noreferrer"
            >
              <button id="githubButton" className="signupFormButtons">
                <img src={github} alt="Github Logo" id="githubLogo" />
                <p>Follow Me on GitHub</p>
              </button>
            </a>

            <p id="reassuranceStatement">
              Want to sign in quickly? Try signing in as Demo User!
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} id="signupForm">
            ...
            <label htmlFor="Birthday" id="birthdayLabel">
              Birthday
            ...
            <p id="signUpLinkBottom">
              Already on Yapp?{" "}
              <span>
                <a href="/login" className="externalsignupFormLinks">
                  Log in
                </a>
              </span>{" "}
              or{" "}
